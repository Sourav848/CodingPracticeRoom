...
public class LRUCache { //LRU = Least Recent Used to remove page for new page reference

	// store keys of cache
	private Deque<Integer> doublyQueue;

	// store references of key in cache using hashset because reference of value cannot be duplicate
