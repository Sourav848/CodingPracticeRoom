...
public final class FinalClassExample {  ////Making Class final so that we cannot extend it.

	private final int id;     //Making fields final so that we cannot change it.
	
	private final String name;
	
	private final HashMap<String,String> testMap;
	
	public int getId() {     //Removed setter method
		return id;
	}
	 ...
	 */
	public HashMap<String, String> getTestMap() {   //Applying cloning.
		//return testMap;
